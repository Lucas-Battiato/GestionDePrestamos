            ...
            <div class="col-md-6">
                <div class="card shadow-sm border-0 rounded-4 p-4 h-100">
                    ...
                    <div class="mb-4">
                        ...
                        <asp:DropDownList ID="ddlProducto" runat="server" CssClass="form-select form-select-lg bg-light text-dark">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group input-group-lg">
                            ...
                            <asp:TextBox ID="txtMonto" runat="server" CssClass="form-control bg-light text-dark" placeholder="Ej: 150000" TextMode="Number"></asp:TextBox>
                        </div>
                    </div>
            ...
            <div class="col-md-6">
                <div class="card shadow-sm border-0 rounded-4 p-4 h-100 bg-white">
                    ...
                    <div class="rounded-4 p-4 bg-light border border-light-subtle">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3 pb-2 border-bottom">
                            <span class="text-secondary fw-medium">Interés total estimado</span>
                            <asp:Label ID="lblInteresResumen" runat="server" CssClass="fw-bold text-danger" Text="$ 0,00"></asp:Label>
                        </div>

                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <span class="text-secondary fw-medium">Costo por cuota (<asp:Label ID="lblCantCuotasResumen" runat="server" Text="0"></asp:Label> pagos)</span>
